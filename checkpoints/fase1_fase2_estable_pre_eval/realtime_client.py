...
class RealtimeSTTClient:
    ...
    def __init__(
        ...
        # timeout=20.0: gpt-4o-transcribe responde en <5 s en condiciones normales.
        # 20 s da margen ante picos de latencia sin bloquear el worker indefinidamente.
        self.client = OpenAI(api_key=openai_api_key, timeout=20.0)
        self.on_transcript = on_transcript
        self._workers = [
