...
- Si en la llamada hay una correccion explicita (el cliente primero dice una calle y luego la corrige diciendo "no, es...", "espera, es...", "me refiero a...", "perdona..."), usa SOLO la version final corregida, no la version inicial equivocada.
...
class ServiceExtractor:
    ...
    def extract(
        ...
        try:
            ...
            # Se propaga para que la UI pueda mostrar un error permanente.
